...
type SidebarMenuButtonProps = React.ComponentProps<'button'> & {
  asChild?: boolean;
  isActive?: boolean;
  /** Shown as native title when sidebar is icon-collapsed (desktop). */
  tooltip?: string;
...
function SidebarMenuButton({
  ...
  const showNativeTip = Boolean(tooltip) && state === 'collapsed' && !isMobile;
  ...
  return (
    <HighlightItem activeClassName={sidebarMenuButtonActiveVariants({ variant })}>
      <Comp
        ...
        title={showNativeTip ? tooltip : undefined}
