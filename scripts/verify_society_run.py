...
def main() -> int:
    ...
    if args.profile == "auto":
        ...
        strict = False
    client_timeout = 600.0 if args.profile == "live-qwen" or args.require_external_worker_all_roles else (300.0 if not strict else 45.0)
    ...
    run = client.create_run(args.scenario, idempotency_key=f"live-create-{args.scenario}-{uuid4()}")
    ...
    recalled = False
    if not args.skip_cross_session_follow_up:
