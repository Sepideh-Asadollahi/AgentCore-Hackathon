...
```bash
python3 -m venv .venv
.venv/bin/pip install -r backend/change-society-service/requirements.txt
...
| # | Document | Current? |
|---:|---|---|
| 16 | [README.md](../README.md) and [14-submission-pack-index.md](14-submission-pack-index.md) links valid | [x] |
